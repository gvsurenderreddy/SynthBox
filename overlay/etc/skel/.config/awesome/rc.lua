...
beautiful.init(awful.util.getdir("config") .. "/suitcase-zenburn/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1:web", "2:file", "3:dev", 4, 5, 6, 7, 8, 9 }, s, awful.layout.suit.floating)
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    --Teardrop
    awful.key({ modkey, "Shift" }, "Return", function() teardrop("urxvt", "bottom", "center", 0.90, 0.30) end) 
)
