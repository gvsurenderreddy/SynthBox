...
mymainmenu = awful.menu.new(
	...
	{ "non-sequencer", ladish_snewapp .. "non-sequencer 'non-sequencer' 2" },
	{ "seq24 sequencer", ladish_snewapp .. "seq24 'seq24 sequencer' 2" },
	{ "bristol mini", ladish_snewapp .. "'startBristol -mini' 'bristol mini' 0" },
	{ "yoshimi synth", ladish_snewapp .. "'yoshimi -j -J' 'yoshimi synth' 2" },
	...
	{ "calf synth/fx host", ladish_snewapp .. "calfjackhost 'calf host' 2" },
	{ "carla synth/fx host", ladish_snewapp .. "carla 'carla host' 0" },
	{ "jconvolver", ladish_snewapp .. "Jc_Gui 'jconvolver' 0" },
	{ "hydrogen", ladish_snewapp .. "hydrogen 'hydrogen' 2" },
	...
	{ "fluidsynth sampler", ladish_snewapp .. "qsynth 'fluidsynth sampler' 2" },
